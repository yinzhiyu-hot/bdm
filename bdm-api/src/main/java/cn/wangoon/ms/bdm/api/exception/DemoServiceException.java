...
/**
 * @Description DemoService远程服务异常定义, 具体抛出此异常的原因
 * @Remark
 * @Author YINZHIYU
 ...
 * @Postscript 人生得意须尽欢
 **/
public class DemoServiceException extends RPCException {
    ...
    public DemoServiceException(String code, String message) {
        super(code, message);
    }
